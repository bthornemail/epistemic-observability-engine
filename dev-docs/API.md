---
id: api-reference
title: "Epistemic Observability Engine - API Reference"
level: intermediate
type: reference
tags: [api, json-rpc, eoe, rpc, documentation]
keywords: [api-reference, json-rpc-2.0, canonicalize, grant-access, evaluate-q, resolve-name, audit-role, register-semantic, health-check, metrics]
prerequisites: []
enables: []
related: [technical-introduction-eoe, installation-guide]
readingTime: 5
difficulty: 2
blackboard:
  status: active
