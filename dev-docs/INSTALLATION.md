...
level: foundational
type: guide
tags: [installation, setup, racket, docker, configuration]
keywords: [installation-guide, setup, racket-installation, docker, prerequisites, quick-start, troubleshooting]
prerequisites: []
enables: [api-reference, integration-guide-polyspherical-rotor]
related: [technical-introduction-eoe]
readingTime: 5
difficulty: 1
blackboard:
  status: active
