---
id: geometric-type-theory-racket
...
keywords: [geometric-type-theory, racket-implementation, spherical-fibrations, principal-ideal-domains, pid, ufd, type-theory]
prerequisites: [eoe-technical-appendix-algebraic-geometric-foundations]
enables: [geometric-type-theory-fibration-categories, mapping-framework-eoe-architecture]
related: [eoe-technical-appendix-algebraic-geometric-foundations, geometric-type-theory-fibration-categories, mapping-framework-eoe-architecture]
readingTime: 35
difficulty: 4
blackboard:
  status: active
