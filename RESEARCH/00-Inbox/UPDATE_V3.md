---
id: update-v3-e6-lie-group-octonions
title: "E6 Lie Group and Octonions"
level: intermediate
type: explanation
tags: [e6, lie-groups, octonions, gut-embedding, eoe-applications]
keywords: [e6-lie-group, octonions, gut-embedding, sl3-complex, unification-layer, eoe-applications]
prerequisites: [eoe-complete-specification]
enables: []
related: [eoe-complete-specification, update-v2-lie-group-f4-applications]
readingTime: 30
difficulty: 3
blackboard:
  status: review
